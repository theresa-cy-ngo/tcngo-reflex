...
// This activity is to view the statistics of Gameshow mode
    // This area is mostly incomplete
public class BuzzerStat extends AppCompatActivity {

    // Initialize the save files and list from the files
    private static final String FILENAME = "gameTwo.sav";
    private ListView buzzer_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buzzer_list = (ListView) findViewById(R.id.buzzerList);
    }
    ...
    protected void onStart() {
        ...
        buzzer_list.setAdapter(adapter);
    }

    // Class to load the array from the file
    private String[] loadFromFile() {
        ArrayList<String> buzzes = new ArrayList<>();
        try {
        ...
        return buzzes.toArray(new String[buzzes.size()]);
    }
